...
Photography is how I keep a record of places outside research. This archive is
organized by region and is designed to grow as new photographs are added.
...
{% for album in site.data.photo_albums %}
  <section class="photo-album" id="{{ album.slug }}">
    ...
    <div class="photo-placeholder">
      <span>Photographs will be added here.</span>
    </div>
    {% endif %}
  </section>
{% endfor %}
